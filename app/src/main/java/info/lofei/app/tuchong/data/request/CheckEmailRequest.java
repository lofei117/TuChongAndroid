 ...
 */
public class CheckEmailRequest extends BaseRequest<BaseResult>{
    public CheckEmailRequest(String email, Response.Listener<BaseResult> listener, Response.ErrorListener errorListener) {
        super(TuChongApi.ACCOUNTS_CHECK_EMAIL + email, listener, errorListener);
    }
