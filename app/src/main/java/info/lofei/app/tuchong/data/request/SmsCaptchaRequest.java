 ...
 */
public class SmsCaptchaRequest extends BaseRequest<BaseResult>{

    public SmsCaptchaRequest(Map<String, String> params, Response.Listener<BaseResult> listener, Response.ErrorListener errorListener) {
        super(Method.POST, TuChongApi.SMS_CAPTCHA, params, listener, errorListener);
    }
