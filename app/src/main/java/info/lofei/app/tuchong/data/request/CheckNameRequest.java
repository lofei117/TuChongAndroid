 ...
 */
public class CheckNameRequest extends BaseRequest<BaseResult>{
    public CheckNameRequest(String username, Response.Listener<BaseResult> listener, Response.ErrorListener errorListener) {
        super(TuChongApi.ACCOUNTS_CHECK_UNAME + username, listener, errorListener);
    }
